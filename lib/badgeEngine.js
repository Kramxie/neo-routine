...
const _CHECKIN_MILESTONES = [1, 50, 100, 500, 1000];
const _GOAL_MILESTONES = [1, 5, 10];
...
// Import from badgeDefinitions (pure function, no DB deps)
import { getCelebrationForBadge } from './badgeDefinitions.js';

// Re-export for backward compatibility
export { getCelebrationForBadge };
