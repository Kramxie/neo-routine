...
/**
 * Edit Template Page
 * Pre-fills form with existing template data and PATCHes on save
 */
    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        <div>
          ...
          <h1 className="text-2xl font-bold text-calm-800">Edit Template</h1>
        </div>
        <Card variant="elevated">
          <CardContent className="p-6">
            <div className="animate-pulse space-y-4">
              <div className="h-4 bg-calm-200 rounded w-1/3" />
              <div className="h-10 bg-calm-100 rounded" />
              <div className="h-4 bg-calm-200 rounded w-1/4" />
              <div className="h-24 bg-calm-100 rounded" />
            </div>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div>
        ...
        <h1 className="text-2xl font-bold text-calm-800">Edit Template</h1>
        <p className="text-calm-500 mt-1">Update your routine blueprint</p>
      </div>
