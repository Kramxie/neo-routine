      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="border-t border-calm-700 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 mt-4 sm:mt-0">
            {/* Social icons */}
            <a href="https://github.com/Kramxie/neo-routine" target="_blank" rel="noopener noreferrer" className="text-calm-500 hover:text-neo-400 transition-colors" aria-label="GitHub">
